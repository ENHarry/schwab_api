...
# Place an order using a trading strategy to non-existen paper account
order_response1 = schwab.trades.place_order(
...
# Place an order using a trading strategy to live account
order_response2 = schwab.trades.place_order(
    account_id='your_account_id',
    asset_type='OPTION',
    trading_strategy='iron_condor',
    is_paper=False,
